...
public class RoomAttachmentVO {
	...
	public RoomAttachmentVO() {
	}

	public RoomAttachmentVO(long picturesNo, long roomNo, String refType, String storedFileName, String originFileName,
	...
	public String toString() {
		return "RoomAttachmentVO [picturesNo=" + picturesNo + ", roomNo=" + roomNo + ", refType=" + refType
