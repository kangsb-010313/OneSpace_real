		...
		<main>
			<div class="container">
				...
				<div id="content">
					...
					<!-- 팀페이지 aside ---------------------------------------------->
					<c:import url="/WEB-INF/views/include/asidepractice.jsp"></c:import>
					<!-- 팀페이지 aside ---------------------------------------------->
										...
										<li class="fav-item">
											<div>
												...
												<div class="fav-item-meta">
													...
													<span class="fav-time">${c.startHour}:00~${c.endHour}:00</span> <span class="fav-duration">${c.durationHours}시간</span>
												</div>
											</div>
											<div class="fav-right">
												<div class="fav-hot">
