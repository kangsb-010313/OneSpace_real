			...
			<div class="container">
				...
				<div id="content">
					...
					<div id="main-content" class="zzim">
						...
						<!-- 하단 CTA 버튼 -->
						<div class="cta-row">
							<button class="btn-outline btn-primary" onclick="location.href='${pageContext.request.contextPath}/team/teams/${empty teamNo ? 6 : teamNo}/posts/writeform?teamPostType=투표'">투표 만들기</button>
