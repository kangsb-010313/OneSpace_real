                            ...
                            <div class="team-wrote-wrap">
                                <div class="post-container">
                                    <div class="post-header">
                                        <h4 class="post-title">팀 원밀리언 연습후기</h4>
                                    </div>
                                    ...
                                    <div class="post-content">
                                        ...
                                        <div class="post-author-info">
                                            <strong>팀 원밀리언</strong>
                                            <span>@1milliondance</span>
                                        </div>
                                        
                                        <!-- 2. 글 내용 표시 영역 -->
                                        <div class="post-text-content">
                                            <p>홍대 네스트 스튜디오 연습실 조명이 좋아서 어떻게 촬영해도 예쁘게 나와요!</p>
                                            <p>이번에 9월 13일에 홍대에서 하는 버스킹 열심히 준비 중이니까 많은 관심 부탁드려요!</p>
                                            <p>자세한 내용은 인스타그램에 공지하도록 하겠습니당ㅎㅎ</p>
                                        </div>

                                        <!-- 3. 첨부 이미지 표시 영역 -->
                                        <div class="post-image-gallery">
                                            <!-- 실제로는 DB에 저장된 이미지 경로를 사용합니다 -->
                                            <img src="../../assets/images/댄스팀 연습 사진01.jpg" alt="팀 연습 사진 1" class="attached-image">
                                            <img src="../../assets/images/댄스팀연습사진02.jpg" alt="팀 연습 사진 2" class="attached-image">
                                        </div>
                                    </div>
                                    <!-- ▲▲▲▲▲ 여기까지 수정되었습니다 ▲▲▲▲▲ -->
