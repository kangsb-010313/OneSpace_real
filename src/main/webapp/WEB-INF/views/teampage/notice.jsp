                            ...
                            <div class="team-wrote-wrap">
                                <div class="post-container">
                                    <div class="post-header">
                                        <h4 class="post-title">팀 원밀리언 새벽연습 관련 공지글입니다.</h4>
                                    </div>
                                    <span class="post-date">2025-07-30</span>
                                    <div class="post-content">
                                        <p>모두 힘드시겠지만 공연을 위해서 조금 더 열심히 해봅시다.<br>
                                        무대 구성이나 오브제 활용 등 아이디어 있으신 분들은 편하게 말씀해주세요.<br>
                                        모두 화이팅!
                                        </p>
                                    </div>
